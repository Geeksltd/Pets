...
namespace MSharp
{
    ...
    static partial class SchemaExtensions
    {
        ...
        [MethodColor("#afcd14")]
        public static PropertyFilterElement<Domain.Pet> Name(this ListModule<Domain.Pet>.SearchComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Search(x => x.Name, file, line);
        
        [MethodColor("#afcd14")]
        public static PropertyFilterElement<Domain.Pet> DateOfBirth(this ListModule<Domain.Pet>.SearchComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Search(x => x.DateOfBirth, file, line);
        
        [MethodColor("#afcd14")]
        public static PropertyFilterElement<Domain.Pet> Type(this ListModule<Domain.Pet>.SearchComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Search(x => x.Type, file, line);
        
        [MethodColor("#afcd14")]
        public static PropertyFilterElement<Domain.PetType> Name(this ListModule<Domain.PetType>.SearchComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Search(x => x.Name, file, line);
        ...
        [MethodColor("#afcd14")]
        public static ViewElement<Domain.Pet> Name(this ViewModule<Domain.Pet>.FieldComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Field(x => x.Name, file, line);
        
        [MethodColor("#afcd14")]
        public static ViewElement<Domain.Pet> DateOfBirth(this ViewModule<Domain.Pet>.FieldComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Field(x => x.DateOfBirth, file, line);
        
        [MethodColor("#afcd14")]
        public static ViewElement<Domain.Pet> Type(this ViewModule<Domain.Pet>.FieldComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Field(x => x.Type, file, line);
        
        [MethodColor("#afcd14")]
        public static ViewElement<Domain.PetType> Name(this ViewModule<Domain.PetType>.FieldComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Field(x => x.Name, file, line);
        ...
        [MethodColor("#0ccc68")]
        public static ViewElement<Domain.Pet> Name(this ListModule<Domain.Pet>.ColumnComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Column(x => x.Name, file, line);
        
        [MethodColor("#0ccc68")]
        public static ViewElement<Domain.Pet> DateOfBirth(this ListModule<Domain.Pet>.ColumnComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Column(x => x.DateOfBirth, file, line);
        
        [MethodColor("#0ccc68")]
        public static ViewElement<Domain.Pet> Type(this ListModule<Domain.Pet>.ColumnComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Column(x => x.Type, file, line);
        
        [MethodColor("#0ccc68")]
        public static ViewElement<Domain.PetType> Name(this ListModule<Domain.PetType>.ColumnComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Column(x => x.Name, file, line);
        ...
        [MethodColor("#AFCD14")]
        public static StringFormElement Name(this FormModule<Domain.Pet>.FieldComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Field(x => x.Name, file, line);
        
        [MethodColor("#AFCD14")]
        public static DateTimeFormElement DateOfBirth(this FormModule<Domain.Pet>.FieldComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Field(x => x.DateOfBirth, file, line);
        ...
        [MethodColor("#AFCD14")]
        public static StringFormElement Name(this FormModule<Domain.PetType>.FieldComponents @this, [CallerFilePath] string file = null, [CallerLineNumber] int line = 0) => @this.module.Field(x => x.Name, file, line);
